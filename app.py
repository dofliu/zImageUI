...
@app.route('/prompt/suggestions', methods=['POST'])
def get_prompt_suggestions():
    ...
    try:
        ...
        # 載入關鍵字資料庫
        keywords_file = os.path.join(os.path.dirname(__file__), "prompt_keywords.json")
...
@app.route('/prompt/apply-template', methods=['POST'])
