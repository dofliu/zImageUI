...
### 6. 文字疊加功能 ✅ **完成 (2025-12-02)**

#### 後端開發
- [x] 新增 `/add-text-overlay` API
- [x] Pillow 圖片處理整合
- [x] 字體庫整合 (支援中文)
- [x] 文字位置計算 (頂部/中間/底部)
- [x] 顏色與背景遮罩控制
...
### 7. 批量導出功能 ✅ **完成 (2025-12-02)**
- [x] PDF 導出 (reportlab)
- [x] PPT 導出 (python-pptx)
- [x] 模板系統 (三種版面/主題)
- [x] 批量處理
- [x] 多選模式 UI
- [x] 導出對話框
...
### 8. 選擇性刪除功能 ✅ **完成 (2025-12-02)**

#### 後端開發
- [x] 新增 `/delete-images` API 路由
- [x] 實作批量刪除邏輯
- [x] 同步刪除檔案與歷史記錄
- [x] 錯誤處理與失敗統計
- [x] 成功/失敗詳細反饋

#### 前端開發 (exportManager.js)
- [x] 新增刪除按鈕 UI
- [x] 刪除按鈕事件監聽器
- [x] deleteSelectedImages() 函數
- [x] 確認對話框實作
- [x] 刪除後重新載入歷史
- [x] 選擇計數更新整合
...
6. ✅ 文字疊加功能 (完整功能)
7. ✅ 批量導出功能 (PDF + PPT)
8. ✅ 選擇性刪除功能 (批量刪除) **新增 v2.3**
9. ✅ 模組化 JavaScript (5 個模組)
10. ✅ 16 個 API 端點
11. ✅ 完整文檔
12. ✅ 前端 UI 整合完成
13. ✅ 關鍵 Bug 修復 (變數重複宣告)
14. ✅ UI/UX 優化 (按鈕顏色、文字顯示) **新增 v2.3**
